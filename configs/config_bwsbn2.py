...
class DefaultConfig(BasicConfig):
    ...
    env = model + '_classification_pretrained_adam_4_rfold8|10'
    Devices_ID = '2'
    use_gpu = True
    ...
    #patientlist2 = '/data/fyl/models_pytorch/BaseweightSharedBNNet_classification_adam_rfold10|10/patientlist2.log'
    patientlist2 = None
    ...
    filelists = dict(
        ...
        test = model_root + '/BaseweightSharedBNNet_bf_classification_adam_rfold10|10/filelist_val_fold0.log'
    )
    filelists2 = dict(
        ...
        test = model_root + '/BaseweightSharedBNNet_bf_classification_adam_rfold10|10/filelist2_val_fold9.log'
    )
    ...
    #load_model_path = model_root + "/BaseweightSharedBNNet_classification_pretrained_adam_2_rfold8|10/BaseweightSharedBNNet_classification_pretrained_adam_2_rfold8|10_epoch11"
    #load_model_path = model_root + "/BaseweightSharedBNNet_bf_classification_pretrained_oa_adam_f1f8/BaseweightSharedBNNet_bf_classification_pretrained_oa_adam_f1f8_epoch40"
    ...
    inference_setup = {'model_name': 'BaseweightSharedBNNet_bf_classification_adam_rfold10|10', 'epochs': [18, 34, 43, 50, 51, 59]}
    input_size = 200
    batch_size = 8
    print_freq = 5
    save_freq = 1
