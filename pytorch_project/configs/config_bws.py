...
class DefaultConfig(BasicConfig):
    ...
    filelists = dict(
        ...
        test = model_root + '/BaseweightSharedBNNet_classification_adam_rfold1|10/filelist_val_fold0.log'
    )
    filelists2 = dict(
        ...
        test = model_root + '/BaseweightSharedBNNet_classification_adam_rfold10|10/filelist2_val_fold9.log'
    )
