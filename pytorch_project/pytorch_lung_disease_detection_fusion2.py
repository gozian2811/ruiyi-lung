...
if __name__ == "__main__":
	...
	net_files = ["/data/fyl/models_pytorch/DensecropNet_nodule_detection_rfold1/DensecropNet_nodule_detection_rfold1_epoch2",
		     "/data/fyl/models_pytorch/DensecropNet_stripe_detection_rfold1/DensecropNet_stripe_detection_rfold1_epoch27"]
	...
	for p in range(len(test_patients)):
		...
		candidate_predictions = nd.precise_detection_pt(image, region_size, candidate_coords, models, None, batch_size, use_gpu=use_gpu, prediction_threshold=0.4)
